...
if has("gui_running")
  ...
  set guifont=MesloLGS-NF:h16,Courier:h16 " list of fonts to use in GUI version of Vim
endif
...
"set autoread " auto reload file if it changes outside of vim
"au FocusGained,BufEnter * :checktime " trigger autoread when changing buffers while inside vim

" enable italics for comments and html arguments
...
" Configure ripgrep to search specific file extensions and ignore specific directories
let g:rg_command = '
  \ rg --column --line-number --no-heading --fixed-strings --ignore-case --no-ignore --hidden --follow --color "always"
  \ -g "*.{js,ts,jsx,tsx,json,php,md,html,css,config,conf}"
  \ -g "!{.git,node_modules,esm,cjs,vendor}/*" '
